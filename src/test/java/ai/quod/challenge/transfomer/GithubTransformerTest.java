...
public class GithubTransformerTest {
  ...
  @Test
  public void testGithubTransformer() {
  ...
  public void testIntegrationGithubTransformer() {
    ...
    System.out.println("Start Transform : " + new Date());
    Transformer<Stream<Map<String,Object>>> git = new GithubTransformer(Arrays.asList(commitMetric,averageMetric,contributorMetric,averageTimeIssues));
    List<Map<String,Object>> result =  git.transform(data).collect(Collectors.toList());
    System.out.println("End Transform : " + new Date());
    System.out.println(result.size());
    result.forEach(System.out::println);
